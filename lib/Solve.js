...
function getDependenciesCached(
  cache /*: DependencyProvider.OnlineVersionsCache */,
  ...
  const dependencies = getDependencies(cache, project.elmJson);
...
function getDependencies(
  ...
  try {
    ...
    return DependencyProvider.solveOnline(elmJsonStr, useTest, extra, cache);
  }
}
